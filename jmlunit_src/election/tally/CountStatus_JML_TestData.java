 ...
 */
public abstract class CountStatus_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public CountStatus_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for CountStatus");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_CountStatusIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_CountStatusStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.CountStatus. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_CountStatusStrategy
