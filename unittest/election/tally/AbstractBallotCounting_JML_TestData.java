// This file was generated by jmlunit on Sat Nov 07 20:27:30 GMT 2009.
 ...
 */
public abstract class AbstractBallotCounting_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public AbstractBallotCounting_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for AbstractBallotCounting");
    }
    ...
    private org.jmlspecs.jmlunit.strategies.ByteStrategyType
        vbyteStrategy
        = new org.jmlspecs.jmlunit.strategies.ByteStrategy()
            {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_DecisionIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_DecisionStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.Decision. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_DecisionStrategy
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_BallotBoxIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_BallotBoxStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.BallotBox. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_BallotBoxStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjava_lang_ThrowableIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjava_lang_ThrowableStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * java.lang.Throwable. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjava_lang_ThrowableStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_CandidateIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_CandidateStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.Candidate. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_CandidateStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_BallotIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_BallotStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.Ballot. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_BallotStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * election.tally.AbstractBallotCounting
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_AbstractBallotCountingIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_AbstractBallotCountingStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.AbstractBallotCounting. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_AbstractBallotCountingStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    //@ requires methodName != null && loopsThisSurrounds >= 0;
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.BooleanIterator
        vbooleanIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vbooleanStrategy.booleanIterator();
    }

    /** The strategy for generating test data of type
     * boolean. */
    private org.jmlspecs.jmlunit.strategies.BooleanStrategyType
        vbooleanStrategy
        = new org.jmlspecs.jmlunit.strategies.BooleanStrategy();
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        velection_tally_ElectionIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return velection_tally_ElectionStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * election.tally.Election. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        velection_tally_ElectionStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * org.jmlspecs.jmlrac.runtime.JMLSurrogate
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlrac_runtime_JMLSurrogateIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlrac_runtime_JMLSurrogateStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlrac.runtime.JMLSurrogate. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlrac_runtime_JMLSurrogateStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjava_lang_Class$_Iter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjava_lang_Class$_Strategy.iterator();
    }

    /** The strategy for generating test data of type
     * java.lang.Class[]. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjava_lang_Class$_Strategy
