 ...
 */
public abstract class Decision_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Decision_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Decision");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.LongStrategy()
            {
                protected long[] addData() {
                    return TestDataGenerator.getLongArray();
                }
            };
        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    return TestDataGenerator.getDecision(n);
                }
            };
}
