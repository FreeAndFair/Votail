// @(#)$Id: ImmutableObjectArrayIterator_JML_TestData.java,v 1.5 2005/07/07 21:03:04 leavens Exp $
 ...
 */
public abstract class ImmutableObjectArrayIterator_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public ImmutableObjectArrayIterator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for ImmutableObjectArrayIterator");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlunit_strategies_ImmutableObjectArrayIteratorIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_ImmutableObjectArrayIteratorStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlunit.strategies.ImmutableObjectArrayIterator. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlunit_strategies_ImmutableObjectArrayIteratorStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.ImmutableObjectArrayIterator[] {
                        new ImmutableObjectArrayIterator
                        (new Object[] { }),
                        new ImmutableObjectArrayIterator
                        (new Object[] { null, }),
                        new ImmutableObjectArrayIterator
                        ...
                        new ImmutableObjectArrayIterator
                        (new Object[] {
                            new JMLObjectSequence(new int[0]),
                            new JMLObjectSequence(new char[0]),
                        }),
                    };
                }
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.ImmutableObjectArrayIterator down$
                        = (org.jmlspecs.jmlunit.strategies.ImmutableObjectArrayIterator) o$;
                    return down$.clone();
                }
            };
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new java.lang.Object[][] {
                        ...
                        new Object[] { null, new java.util.HashMap(), },
                        new Object[] {
                            new JMLObjectSequence(new int[0]),
                            new JMLObjectSequence(new char[0]),
                        },
