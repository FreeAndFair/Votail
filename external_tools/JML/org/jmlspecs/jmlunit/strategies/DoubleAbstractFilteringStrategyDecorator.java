// @(#)$Id: doubleAbstractFilteringStrategyDecorator.java-generic,v 1.7 2005/12/24 21:20:31 chalin Exp $
...
/*@ nullable_by_default @*/ 
public abstract class DoubleAbstractFilteringStrategyDecorator
    extends DoubleAbstractStrategy
{
    /** The test data */
    private final /*@ spec_public non_null@*/ DoubleStrategyType rawData;
    ...
    public DoubleAbstractFilteringStrategyDecorator
    ...
    public /*@ non_null @*/ DoubleIterator doubleIterator() {
        /** The filtering iterator to return, defined to allow for an
         * explicit constructor. */
        class NewIter extends DoubleAbstractFilteringIteratorDecorator
        {
            ...
            //@ ensures !dented;
            public NewIter(DoubleIterator iter) {
                super(iter, (double)0);
                super.initialize();
            }
            ...
            public /*@ pure @*/ boolean approve(double elem) {
                return DoubleAbstractFilteringStrategyDecorator
                    .this.approve(elem);
            }
        }
        
        return new NewIter(rawData.doubleIterator());
    }
