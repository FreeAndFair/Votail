// @(#)$Id: booleanArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends BooleanAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ boolean[] elems;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public BooleanArrayIterator(/*@ non_null @*/ boolean[] elems) {
        this.elems = (boolean[]) elems.clone();
    }
    ...
    /*@ protected normal_behavior
      ...
      @*/
    protected BooleanArrayIterator
        (int next, /*@ non_null @*/ boolean[] elems)
    {
        this.elems = (boolean[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Boolean(\result).equals(new Boolean(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new BooleanArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "BooleanArrayIterator(" + next + ", new boolean[] {";
