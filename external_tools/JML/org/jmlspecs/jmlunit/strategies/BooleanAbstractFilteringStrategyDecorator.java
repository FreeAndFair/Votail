// @(#)$Id: booleanAbstractFilteringStrategyDecorator.java-generic,v 1.7 2005/12/24 21:20:31 chalin Exp $
...
{
    /** The test data */
    private final /*@ spec_public non_null@*/ BooleanStrategyType rawData;
    ...
    public BooleanAbstractFilteringStrategyDecorator
        (BooleanStrategyType strat)
    {
        rawData = strat;
    }
    ...
    public /*@ non_null @*/ BooleanIterator booleanIterator() {
        ...
        class NewIter extends BooleanAbstractFilteringIteratorDecorator
        {
            ...
            //@ ensures !dented;
            public NewIter(BooleanIterator iter) {
                super(iter, (boolean)false);
                super.initialize();
            }

            // doc comment and specification inherited
            public /*@ pure @*/ boolean approve(boolean elem) {
                return BooleanAbstractFilteringStrategyDecorator
                    .this.approve(elem);
            }
        }
        
        return new NewIter(rawData.booleanIterator());
    }
