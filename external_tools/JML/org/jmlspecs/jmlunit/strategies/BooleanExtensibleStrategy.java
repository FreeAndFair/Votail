// @(#)$Id: booleanExtensibleStrategy.java-generic,v 1.5 2005/12/24 21:20:31 chalin Exp $
 ...
 */
public abstract class BooleanExtensibleStrategy
    extends BooleanAbstractStrategy
{
    /** The data to return in the iterations */
    private /*@ nullable @*/ boolean[] data = null;  //@ in objectState;
    ...
    public synchronized BooleanIterator booleanIterator() {
        ...
        return new BooleanArrayIterator(data);
    }
    ...
    protected boolean[] getData() {
        boolean[] defd = defaultData();
        boolean[] ret = defd;
        boolean[] added = addData();
        if (added.length != 0) {
            ret = new boolean[defd.length + added.length];
