// @(#)$Id: longAbstractFilteringStrategyDecorator.java-generic,v 1.7 2005/12/24 21:20:31 chalin Exp $
...
/*@ nullable_by_default @*/ 
public abstract class LongAbstractFilteringStrategyDecorator
    extends LongAbstractStrategy
{
    /** The test data */
    private final /*@ spec_public non_null@*/ LongStrategyType rawData;
    ...
    public LongAbstractFilteringStrategyDecorator
    ...
    public /*@ non_null @*/ LongIterator longIterator() {
        ...
        class NewIter extends LongAbstractFilteringIteratorDecorator
        {
            ...
            //@ ensures !dented;
            public NewIter(LongIterator iter) {
                super(iter, (long)0);
                super.initialize();
            }
            ...
            public /*@ pure @*/ boolean approve(long elem) {
                return LongAbstractFilteringStrategyDecorator
                    .this.approve(elem);
            }
        }
        
        return new NewIter(rawData.longIterator());
    }
