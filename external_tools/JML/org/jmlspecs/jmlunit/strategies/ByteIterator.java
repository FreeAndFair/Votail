// @(#)$Id: byteIterator.java-generic,v 1.10 2005/12/24 21:20:31 chalin Exp $
 ...
 * values of type byte without casting.
...
public interface ByteIterator extends IndefiniteIterator {
    ...
    /*@ also
      @  public normal_behavior
      @    assignable \nothing;
      @    ensures \fresh(\result) && \result instanceof ByteIterator;
      @    ensures \result != this;
      @    ensures_redundantly \result != null;
      @    ensures ((ByteIterator)\result).atEnd() == atEnd();
      @    ensures !atEnd() ==>
      @            new Byte(((ByteIterator)\result).getByte())
      @            .equals(new Byte(getByte()));
      @*/
    /*@ pure @*/ Object clone();
}
