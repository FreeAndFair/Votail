// @(#)$Id: booleanExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
 ...
 * boolean) that allows for easy extension to the test data of the
 * underlying strategy.
 *
 * <p>
 ...
 */
public class BooleanExtensibleStrategyDecorator
    extends BooleanAbstractStrategy
{
    /** The default data, returned first in the iterations. */
    private /*@ spec_public non_null @*/ BooleanStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ BooleanStrategyType addedData;
    ...
    public BooleanExtensibleStrategyDecorator
        (/*@ non_null @*/ BooleanStrategyType strat)
    {
        defaultData = strat;
        addedData = new BooleanExtensibleStrategy() {
                protected boolean[] defaultData() {
                    return BooleanExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ BooleanIterator booleanIterator() {
        return new BooleanCompositeIterator
            (defaultData.booleanIterator(),
             addedData.booleanIterator());
    }
