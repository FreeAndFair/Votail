// @(#)$Id: doubleAbstractFilteringIteratorDecorator.java-generic,v 1.11 2005/12/24 21:20:31 chalin Exp $
...
{
    private /*@ spec_public non_null @*/ DoubleIterator rawElems;
    ...
    /*@ public invariant !dented ==>
      ...
      @                 .equals(new Double(rawElems.getDouble())));
      @*/
    ...
    /*@ public normal_behavior
      ...
      @   ensures owner == null;
      @*/
    public DoubleAbstractFilteringIteratorDecorator
        (DoubleIterator iter)
    {
        rawElems = (DoubleIterator) iter.clone();
    ...
    /*@ public normal_behavior
      ...
      @*/
    public DoubleAbstractFilteringIteratorDecorator
        (DoubleIterator iter, double ignored)
    {
        //@ set dented = true;
        rawElems = (DoubleIterator) iter.clone();
        //@ set rawElems.owner = this;
    ...
    //@ ensures !dented;
    //@ ensures !atEnd() ==> approve(getDouble());
    ...
    //@ ensures !rawElems.atEnd() ==> approve(rawElems.getDouble());
    private void setCursor() {
        while (!rawElems.atEnd() && !approve(rawElems.getDouble())) {
            rawElems.advance();
        }
    }
    ...
    //@ public normal_behavior
    //@   assignable \nothing;
    public abstract /*@ pure @*/ boolean approve(double elem);
    ...
    public /*@ non_null @*/ Object clone() {
        DoubleAbstractFilteringIteratorDecorator ret
            = (DoubleAbstractFilteringIteratorDecorator) super.clone();
        ret.rawElems = (DoubleIterator) rawElems.clone();
        return ret;
    }
