// @(#)$Id: shortIterator.java-generic,v 1.10 2005/12/24 21:20:31 chalin Exp $
 ...
 * values of type short without casting.
...
public interface ShortIterator extends IndefiniteIterator {
    ...
    /** Return the current short in this iterator. */
    /*@ public behavior
      @     assignable \nothing;
    ...
    /*@ also
      @  public normal_behavior
      @    assignable \nothing;
      @    ensures \fresh(\result) && \result instanceof ShortIterator;
      @    ensures \result != this;
      @    ensures_redundantly \result != null;
      @    ensures ((ShortIterator)\result).atEnd() == atEnd();
      @    ensures !atEnd() ==>
      @            new Short(((ShortIterator)\result).getShort())
      @            .equals(new Short(getShort()));
      @*/
    /*@ pure @*/ Object clone();
}
