// @(#)$Id: doubleExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
    ...
    extends DoubleAbstractStrategy
{
    ...
    private /*@ spec_public non_null @*/ DoubleStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ DoubleStrategyType addedData;
    ...
    public DoubleExtensibleStrategyDecorator
        (/*@ non_null @*/ DoubleStrategyType strat)
    {
        defaultData = strat;
        addedData = new DoubleExtensibleStrategy() {
                protected double[] defaultData() {
                    return DoubleExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ DoubleIterator doubleIterator() {
        return new DoubleCompositeIterator
            (defaultData.doubleIterator(),
             addedData.doubleIterator());
    }
