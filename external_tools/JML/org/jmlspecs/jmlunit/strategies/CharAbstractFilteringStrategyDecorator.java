// @(#)$Id: charAbstractFilteringStrategyDecorator.java-generic,v 1.7 2005/12/24 21:20:31 chalin Exp $
...
/*@ nullable_by_default @*/ 
public abstract class CharAbstractFilteringStrategyDecorator
    extends CharAbstractStrategy
{
    /** The test data */
    private final /*@ spec_public non_null@*/ CharStrategyType rawData;
    ...
    public CharAbstractFilteringStrategyDecorator
        (CharStrategyType strat)
    {
        rawData = strat;
    }
    ...
    public /*@ non_null @*/ CharIterator charIterator() {
        ...
        class NewIter extends CharAbstractFilteringIteratorDecorator
        {
            ...
            //@ ensures !dented;
            public NewIter(CharIterator iter) {
                super(iter, (char)0);
                super.initialize();
            }

            // doc comment and specification inherited
            public /*@ pure @*/ boolean approve(char elem) {
                return CharAbstractFilteringStrategyDecorator
                    .this.approve(elem);
            }
        }
        
        return new NewIter(rawData.charIterator());
    }
