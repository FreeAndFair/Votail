// @(#)$Id: DoubleAbstractFilteringIteratorDecorator_JML_TestData.java,v 1.2 2005/07/07 21:03:04 leavens Exp $
 ...
 */
public abstract class DoubleAbstractFilteringIteratorDecorator_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public DoubleAbstractFilteringIteratorDecorator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for DoubleAbstractFilteringIteratorDecorator");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.DoubleIterator
        vdoubleIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vdoubleStrategy.doubleIterator();
    }

    /** The strategy for generating test data of type
     * double. */
    private org.jmlspecs.jmlunit.strategies.DoubleStrategyType
        vdoubleStrategy
        = new org.jmlspecs.jmlunit.strategies.DoubleBigStrategy()
            {
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlunit_strategies_DoubleAbstractFilteringIteratorDecoratorIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_DoubleAbstractFilteringIteratorDecoratorStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlunit.strategies.DoubleAbstractFilteringIteratorDecorator. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlunit_strategies_DoubleAbstractFilteringIteratorDecoratorStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.DoubleAbstractFilteringIteratorDecorator[] {
                        new DoubleNonNegativeIteratorDecorator
                        (new DoubleStrategy().doubleIterator()),
                        new DoubleNonNegativeIteratorDecorator
                        (new DoubleBigStrategy().doubleIterator()),
                        new DoubleAbstractFilteringIteratorDecorator
                        (new DoubleBigStrategy().doubleIterator())
                        {
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.DoubleAbstractFilteringIteratorDecorator down$
                        = (org.jmlspecs.jmlunit.strategies.DoubleAbstractFilteringIteratorDecorator) o$;
                    return down$.clone();
                }
            };
}
