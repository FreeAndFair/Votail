// @(#)$Id: doubleCompositeIterator.java-generic,v 1.10 2005/12/24 21:20:31 chalin Exp $
...
/*@ nullable_by_default @*/ 
public class DoubleCompositeIterator
    extends DoubleAbstractIterator
{
    ...
    private final /*@ spec_public non_null @*/ DoubleIterator[] iters;
    //@ in objectState;
    ...
    /*@ assignable iters, currentIterator, owner;
      ...
      @            new DoubleIterator[] {iter} *);
      @ ensures owner == null;
      @*/
    public DoubleCompositeIterator
        (/*@ non_null @*/ DoubleIterator iter)
    {
        this(new DoubleIterator[] {iter});
    }
    ...
    /*@ assignable iters, currentIterator, owner;
      ...
      @*/
    public DoubleCompositeIterator
        (/*@ non_null @*/ DoubleIterator iter1, 
         /*@ non_null @*/ DoubleIterator iter2)
    {
        this(new DoubleIterator[] {iter1, iter2});
    }
    ...
    /*@ requires \nonnullelements(iters);
      ...
      @                && (!this.iters[i].atEnd()
      @                    ==> new Double(this.iters[i].getDouble())
      @                        .equals(new Double(iters[i].getDouble()))));
      @ ensures owner == null;
      @*/
    public DoubleCompositeIterator
        (/*@ non_null @*/ DoubleIterator[] iters)
    {
        this.iters = new DoubleIterator[iters.length];
        for (int i = 0; i < iters.length; i++) {
            this.iters[i] = (DoubleIterator) iters[i].clone();
    ...
    /*@ requires 0 <= currentIterator && currentIterator <= iters.length;
      ...
      @ ensures owner == null;
      @*/
    protected DoubleCompositeIterator
        (int currentIterator,
         /*@ non_null @*/ DoubleIterator[] iters)
    ...
    /*@ also
      ...
      @*/
    public /*@ pure @*/ double getDouble()
        throws NoSuchElementException
    {
        if (currentIterator < iters.length) {
            return iters[currentIterator].getDouble();
        } else {
    ...
    public /*@ non_null @*/ Object clone() {
        return new DoubleCompositeIterator(currentIterator, iters);
    }

    public /*@ non_null @*/ String toString() {
        String ret
            = "DoubleCompositeIterator(" + currentIterator
            + ", new DoubleIterator[] {";
        for (int i = 0; i < iters.length; i++) {
            ret += iters[i] + ", ";
        }
