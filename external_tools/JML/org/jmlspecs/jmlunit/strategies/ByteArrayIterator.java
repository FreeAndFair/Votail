// @(#)$Id: byteArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends ByteAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ byte[] elems;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public ByteArrayIterator(/*@ non_null @*/ byte[] elems) {
        this.elems = (byte[]) elems.clone();
    }
    ...
    /*@ protected normal_behavior
      ...
      @*/
    protected ByteArrayIterator
        (int next, /*@ non_null @*/ byte[] elems)
    {
        this.elems = (byte[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Byte(\result).equals(new Byte(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new ByteArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "ByteArrayIterator(" + next + ", new byte[] {";
