// @(#)$Id: byteAbstractFilteringStrategyDecorator.java-generic,v 1.7 2005/12/24 21:20:31 chalin Exp $
...
/*@ nullable_by_default @*/ 
public abstract class ByteAbstractFilteringStrategyDecorator
    extends ByteAbstractStrategy
{
    /** The test data */
    private final /*@ spec_public non_null@*/ ByteStrategyType rawData;
    ...
    public ByteAbstractFilteringStrategyDecorator
    ...
    public /*@ non_null @*/ ByteIterator byteIterator() {
        ...
        class NewIter extends ByteAbstractFilteringIteratorDecorator
        {
            ...
            //@ ensures !dented;
            public NewIter(ByteIterator iter) {
                super(iter, (byte)0);
                super.initialize();
            }

            // doc comment and specification inherited
            public /*@ pure @*/ boolean approve(byte elem) {
                return ByteAbstractFilteringStrategyDecorator
                    .this.approve(elem);
            }
        }
        
        return new NewIter(rawData.byteIterator());
    }
