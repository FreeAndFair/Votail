// @(#)$Id: shortExtensibleStrategy.java-generic,v 1.5 2005/12/24 21:20:31 chalin Exp $
 ...
 */
public abstract class ShortExtensibleStrategy
    extends ShortAbstractStrategy
{
    /** The data to return in the iterations */
    private /*@ nullable @*/ short[] data = null;  //@ in objectState;
    ...
    protected short[] getData() {
        short[] defd = defaultData();
        short[] ret = defd;
        short[] added = addData();
        if (added.length != 0) {
            ret = new short[defd.length + added.length];
