// @(#)$Id: intExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
 ...
 * int) that allows for easy extension to the test data of the
 * underlying strategy.
 *
 * <p>
    ...
    extends IntAbstractStrategy
{
    ...
    private /*@ spec_public non_null @*/ IntStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ IntStrategyType addedData;
    ...
    public IntExtensibleStrategyDecorator
        (/*@ non_null @*/ IntStrategyType strat)
    {
        defaultData = strat;
        addedData = new IntExtensibleStrategy() {
                protected int[] defaultData() {
                    return IntExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ IntIterator intIterator() {
        return new IntCompositeIterator
            (defaultData.intIterator(),
             addedData.intIterator());
    }
