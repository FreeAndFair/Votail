// @(#)$Id: doubleArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends DoubleAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ double[] elems;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public DoubleArrayIterator(/*@ non_null @*/ double[] elems) {
    ...
    protected DoubleArrayIterator
        (int next, /*@ non_null @*/ double[] elems)
    {
        this.elems = (double[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Double(\result).equals(new Double(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new DoubleArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "DoubleArrayIterator(" + next + ", new double[] {";
