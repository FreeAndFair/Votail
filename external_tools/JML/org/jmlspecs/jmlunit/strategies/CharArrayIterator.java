// @(#)$Id: charArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends CharAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ char[] elems;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public CharArrayIterator(/*@ non_null @*/ char[] elems) {
        this.elems = (char[]) elems.clone();
    }
    ...
    /*@ protected normal_behavior
      ...
      @*/
    protected CharArrayIterator
        (int next, /*@ non_null @*/ char[] elems)
    {
        this.elems = (char[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Character(\result).equals(new Character(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new CharArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "CharArrayIterator(" + next + ", new char[] {";
