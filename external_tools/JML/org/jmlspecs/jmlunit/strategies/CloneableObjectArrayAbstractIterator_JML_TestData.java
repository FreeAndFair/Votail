// @(#)$Id: CloneableObjectArrayAbstractIterator_JML_TestData.java,v 1.3 2005/07/07 21:03:04 leavens Exp $
 ...
 */
public abstract class CloneableObjectArrayAbstractIterator_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public CloneableObjectArrayAbstractIterator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for CloneableObjectArrayAbstractIterator");
    }
    ...
    class IntArrayArrayIterator extends CloneableObjectArrayAbstractIterator {
        public IntArrayArrayIterator(int[][] elems) {
            super(elems);
        }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlunit_strategies_CloneableObjectArrayAbstractIteratorIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_CloneableObjectArrayAbstractIteratorStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlunit.strategies.CloneableObjectArrayAbstractIterator. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlunit_strategies_CloneableObjectArrayAbstractIteratorStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.CloneableObjectArrayAbstractIterator[] {
                        new IntArrayArrayIterator(new int[][]{}),
                        new IntArrayArrayIterator
                        (new int[][]{null, new int[]{3, 4,}}),
                        new IntArrayArrayIterator
                         (new int[][]{new int[]{3, 4,}, null,
                                      new int[]{}}),
                    };
                }
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.CloneableObjectArrayAbstractIterator down$
                        = (org.jmlspecs.jmlunit.strategies.CloneableObjectArrayAbstractIterator) o$;
                    return down$.clone();
                }
            };
}
