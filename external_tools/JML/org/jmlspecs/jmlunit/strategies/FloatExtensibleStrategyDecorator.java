// @(#)$Id: floatExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
 ...
 * float) that allows for easy extension to the test data of the
 * underlying strategy.
 *
 * <p>
 ...
 */
public class FloatExtensibleStrategyDecorator
    extends FloatAbstractStrategy
{
    /** The default data, returned first in the iterations. */
    private /*@ spec_public non_null @*/ FloatStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ FloatStrategyType addedData;
    ...
    public FloatExtensibleStrategyDecorator
        (/*@ non_null @*/ FloatStrategyType strat)
    {
        defaultData = strat;
        addedData = new FloatExtensibleStrategy() {
                protected float[] defaultData() {
                    return FloatExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ FloatIterator floatIterator() {
        return new FloatCompositeIterator
            (defaultData.floatIterator(),
             addedData.floatIterator());
    }
