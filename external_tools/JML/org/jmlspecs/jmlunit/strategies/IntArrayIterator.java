// @(#)$Id: intArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends IntAbstractIterator
{
    ...
    /*@ public normal_behavior
      ...
      @*/
    public IntArrayIterator(/*@ non_null @*/ int[] elems) {
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Integer(\result).equals(new Integer(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new IntArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "IntArrayIterator(" + next + ", new int[] {";
