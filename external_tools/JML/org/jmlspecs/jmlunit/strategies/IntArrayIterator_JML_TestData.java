// @(#)$Id: IntArrayIterator_JML_TestData.java,v 1.2 2005/07/07 21:03:04 leavens Exp $
 ...
 */
public abstract class IntArrayIterator_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public IntArrayIterator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for IntArrayIterator");
    }
    ...
    {
        return vint$_Strategy.iterator();
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlunit_strategies_IntArrayIteratorIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_IntArrayIteratorStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlunit.strategies.IntArrayIterator. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlunit_strategies_IntArrayIteratorStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.IntArrayIterator[] {
                        new IntArrayIterator(new int[]{}),
                        new IntArrayIterator(new int[]{0}),
                        new IntArrayIterator(new int[] {1, -1, 0, 342, -541, }),
                        new IntArrayIterator(new int[] {-1, -2, -3, }),
                    };
                }
                ...
                //@ requires o$ != null;
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.IntArrayIterator down$
                        = (org.jmlspecs.jmlunit.strategies.IntArrayIterator) o$;
                    return down$.clone();
                }
            };
}
