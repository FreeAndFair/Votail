// @(#)$Id: shortArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends ShortAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ short[] elems;
    ...
    /*@ public normal_behavior
      ...
      @*/
    public ShortArrayIterator(/*@ non_null @*/ short[] elems) {
        this.elems = (short[]) elems.clone();
    }
    ...
    /*@ protected normal_behavior
      ...
      @*/
    protected ShortArrayIterator
        (int next, /*@ non_null @*/ short[] elems)
    {
        this.elems = (short[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Short(\result).equals(new Short(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new ShortArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "ShortArrayIterator(" + next + ", new short[] {";
