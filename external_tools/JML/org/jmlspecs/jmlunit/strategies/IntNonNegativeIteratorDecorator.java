// @(#)$Id: intNonNegativeIteratorDecorator.java-generic,v 1.4 2005/12/06 19:54:59 chalin Exp $
...
/*@ nullable_by_default @*/ 
public class IntNonNegativeIteratorDecorator
    extends IntAbstractFilteringIteratorDecorator
{
    /*@ public normal_behavior
      ...
      @*/
    public IntNonNegativeIteratorDecorator(IntIterator iter) {
        super(iter);
    }
