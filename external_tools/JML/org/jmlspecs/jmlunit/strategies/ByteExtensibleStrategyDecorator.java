// @(#)$Id: byteExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
 ...
 * byte) that allows for easy extension to the test data of the
 * underlying strategy.
 *
 * <p>
 ...
 */
public class ByteExtensibleStrategyDecorator
    extends ByteAbstractStrategy
{
    /** The default data, returned first in the iterations. */
    private /*@ spec_public non_null @*/ ByteStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ ByteStrategyType addedData;
    ...
    public ByteExtensibleStrategyDecorator
        (/*@ non_null @*/ ByteStrategyType strat)
    {
        defaultData = strat;
        addedData = new ByteExtensibleStrategy() {
                protected byte[] defaultData() {
                    return ByteExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ ByteIterator byteIterator() {
        return new ByteCompositeIterator
            (defaultData.byteIterator(),
             addedData.byteIterator());
    }
