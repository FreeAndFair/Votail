// This file was generated by jmlunit on Sun Jan 25 00:03:03 CST 2004.
    ...
    extends junit.framework.TestCase
{
    ...
    public DoubleCompositeIterator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for DoubleCompositeIterator");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.DoubleIterator[] down$
                        = (org.jmlspecs.jmlunit.strategies.DoubleIterator[]) o$;
                    return down$.clone();
                }
            };
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_DoubleCompositeIteratorStrategy.iterator();
    }
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.DoubleCompositeIterator[] {
                        new DoubleCompositeIterator(new DoubleIterator[]{}),
                        new DoubleCompositeIterator
                        (new DoubleBigStrategy().doubleIterator()),
                        new DoubleCompositeIterator
                        (new DoubleStrategy().doubleIterator(),
                         new DoubleBigStrategy().doubleIterator()),
                ...
                //@ requires o$ != null;
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.DoubleCompositeIterator down$
                        = (org.jmlspecs.jmlunit.strategies.DoubleCompositeIterator) o$;
                    return down$.clone();
                }
            };
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_DoubleIteratorStrategy.iterator();
    }
