// @(#)$Id: floatArrayIterator.java-generic,v 1.9 2005/12/24 21:20:31 chalin Exp $
    ...
    extends FloatAbstractIterator
{
    ...
    /** The elements */
    private /*@ spec_public non_null @*/ float[] elems;
    ...
    /*@ protected normal_behavior
      ...
      @*/
    protected FloatArrayIterator
        (int next, /*@ non_null @*/ float[] elems)
    {
        this.elems = (float[]) elems.clone();
        this.next = next;
    }
    ...
    /*@ also
      ...
      @    assignable \nothing;
      @    ensures new Float(\result).equals(new Float(elems[next]));
      @ also
    ...
    public /*@ non_null @*/ Object clone() {
        return new FloatArrayIterator(next, elems);
    }

    // doc comment and specification inherited
    public /*@ non_null @*/ String toString() {
        String ret =
            "FloatArrayIterator(" + next + ", new float[] {";
