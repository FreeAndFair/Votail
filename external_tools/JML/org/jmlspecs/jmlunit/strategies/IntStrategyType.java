// @(#)$Id: intStrategyType.java-generic,v 1.8 2005/12/24 21:20:31 chalin Exp $
...
public interface IntStrategyType extends StrategyType {
    ...
    /** Compute a fresh IntIterator, which can be used to
     * provide test data of type int.  The
     * IntIterator returned should be freshly created.
