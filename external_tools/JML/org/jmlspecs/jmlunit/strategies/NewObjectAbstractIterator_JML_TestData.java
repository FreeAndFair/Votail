// @(#)$Id: NewObjectAbstractIterator_JML_TestData.java,v 1.2 2005/07/07 21:03:04 leavens Exp $
 ...
 */
public abstract class NewObjectAbstractIterator_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public NewObjectAbstractIterator_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for NewObjectAbstractIterator");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_jmlunit_strategies_NewObjectAbstractIteratorIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_jmlunit_strategies_NewObjectAbstractIteratorStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.jmlunit.strategies.NewObjectAbstractIterator. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_jmlunit_strategies_NewObjectAbstractIteratorStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.jmlunit.strategies.NewObjectAbstractIterator[] {
                        new EmptyNewObjectIterator(),
                        new NewObjectAbstractIterator() {
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.jmlunit.strategies.NewObjectAbstractIterator down$
                        = (org.jmlspecs.jmlunit.strategies.NewObjectAbstractIterator) o$;
                    return down$.clone();
                }
            };
}
