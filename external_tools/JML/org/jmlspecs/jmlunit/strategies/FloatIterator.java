// @(#)$Id: floatIterator.java-generic,v 1.10 2005/12/24 21:20:31 chalin Exp $
 ...
 * values of type float without casting.
 * @see IndefiniteIterator
 * @author Gary T. Leavens
 */
public interface FloatIterator extends IndefiniteIterator {
    ...
    /*@ also
      @  public normal_behavior
      @    assignable \nothing;
      @    ensures \fresh(\result) && \result instanceof FloatIterator;
      @    ensures \result != this;
      @    ensures_redundantly \result != null;
      @    ensures ((FloatIterator)\result).atEnd() == atEnd();
      @    ensures !atEnd() ==>
      @            new Float(((FloatIterator)\result).getFloat())
      @            .equals(new Float(getFloat()));
      @*/
    /*@ pure @*/ Object clone();
}
