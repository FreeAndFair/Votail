// @(#)$Id: longExtensibleStrategyDecorator.java-generic,v 1.6 2005/12/24 21:20:31 chalin Exp $
 ...
 * long) that allows for easy extension to the test data of the
 * underlying strategy.
 *
 * <p>
 ...
 */
public class LongExtensibleStrategyDecorator
    extends LongAbstractStrategy
{
    /** The default data, returned first in the iterations. */
    private /*@ spec_public non_null @*/ LongStrategyType defaultData;
    ...
    private /*@ spec_public non_null @*/ LongStrategyType addedData;
    ...
    public LongExtensibleStrategyDecorator
        (/*@ non_null @*/ LongStrategyType strat)
    {
        defaultData = strat;
        addedData = new LongExtensibleStrategy() {
                protected long[] defaultData() {
                    return LongExtensibleStrategyDecorator
                        .this.addData();
                }
            };
    ...
    public /*@ non_null @*/ LongIterator longIterator() {
        return new LongCompositeIterator
            (defaultData.longIterator(),
             addedData.longIterator());
    }
