// @(#)$Id: JMLDataGroup_JML_TestData.java,v 1.5 2004/01/25 15:42:09 leavens Exp $
 ...
 *
 */
public abstract class JMLDataGroup_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public JMLDataGroup_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JMLDataGroup");
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_lang_JMLDataGroupIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_lang_JMLDataGroupStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.lang.JMLDataGroup. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_lang_JMLDataGroupStrategy
        = new org.jmlspecs.jmlunit.strategies.ImmutableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.lang.JMLDataGroup[] {
                        JMLDataGroup.IT,
                    };
                }
            };
