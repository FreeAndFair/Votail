// @(#)$Id: Person_JML_TestData.java,v 1.4 2005/08/24 20:45:58 leavens Exp $
 ...
 *
 */
public abstract class Person_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Person_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Person");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_jmltutorial_PersonIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_jmltutorial_PersonStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.jmltutorial.Person. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_jmltutorial_PersonStrategy
