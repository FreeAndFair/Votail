// This file was generated by jmlunit on Fri Jul 08 16:49:17 CDT 2005.
 ...
 */
public abstract class PriorityQueue_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public PriorityQueue_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for PriorityQueue");
    }
    ...
    {
        return vorg_jmlspecs_samples_jmlkluwer_PriorityQueueStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.jmlkluwer.PriorityQueue. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_jmlkluwer_PriorityQueueStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 1:
                        ...
                        pq.addEntry("entry1", 3);
                        return pq;
                    case 2:
                        pq = new PriorityQueue();
                        pq.addEntry("entry1", 3);
                        pq.addEntry("entry2", 1);
                        pq.addEntry("entry3", 3);
                        pq.addEntry("entry4", 0);
                        return pq;
                    case 3:
                        pq = new PriorityQueue();
                        pq.addEntry("four1", 4);
        ...
        = new org.jmlspecs.jmlunit.strategies.ObjectStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 0:
                        return new PriorityQueue();
                    case 1:
                        return new QueueEntry("foo", 3, 342);
                    case 2:
                        return new Object();
                    default:
                        break;
