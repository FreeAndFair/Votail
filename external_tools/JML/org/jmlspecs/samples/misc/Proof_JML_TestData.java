// @(#)$Id: Proof_JML_TestData.java,v 1.4 2004/01/26 23:31:11 leavens Exp $
 ...
 *
 */
public abstract class Proof_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Proof_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Proof");
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_misc_ProofIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_misc_ProofStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.misc.Proof. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_misc_ProofStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 0:
                        return null;
                    case 1:
                        return new org.jmlspecs.samples.misc.Proof();
                    default:
                        break;
                    }
