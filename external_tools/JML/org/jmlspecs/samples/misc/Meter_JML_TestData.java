// @(#)$Id: Meter_JML_TestData.java,v 1.3 2004/01/22 20:01:10 leavens Exp $
 ...
 *
 */
public abstract class Meter_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Meter_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Meter");
    }
     ...
     * org.jmlspecs.samples.misc.Meter
        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 0:
                        return null;
                    case 1:
                        return new org.jmlspecs.samples.misc.Meter();
                    default:
                        break;
                    }
