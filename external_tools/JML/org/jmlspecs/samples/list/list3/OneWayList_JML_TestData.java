    ...
    extends junit.framework.TestCase
{
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_list3_OneWayListIter
    ...
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_list3_OneWayListStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    org.jmlspecs.samples.list.list3.OneWayList[] receivers
                        = new org.jmlspecs.samples.list.list3.OneWayList[] {
                            new OneWayList(),
                            new OneWayList(),
                            new OneWayList(),
                            new OneWayList(),
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.list3.OneWayList down$
                        = (org.jmlspecs.samples.list.list3.OneWayList) o$;
                    return down$.clone();
                }
            };
