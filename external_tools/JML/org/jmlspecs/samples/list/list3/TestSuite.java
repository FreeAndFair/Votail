...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public static junit.framework.Test suite() {
        ...
        suite.addTest( org.jmlspecs.samples.list.list3.OneWayList_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list3.E_OneWayList_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list3.TwoWayList_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list3.TwoWayIterator_JML_Test.suite() );
        return suite;
    }

    public static final String TEST_DESC = 
        "Test suite for org.jmlspecs.samples.list.list3";
}
