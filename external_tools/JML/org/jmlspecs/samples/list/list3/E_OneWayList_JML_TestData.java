// @(#)$Id: E_OneWayList_JML_TestData.java,v 1.4 2004/07/22 16:46:02 cruby Exp $
    ...
    extends junit.framework.TestCase
{
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_list3_E_OneWayListIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_list_list3_E_OneWayListStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.list.list3.E_OneWayList. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_list3_E_OneWayListStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    org.jmlspecs.samples.list.list3.E_OneWayList[] receivers
                        = new E_OneWayList[] { 
                            new E_OneWayList(),
                            new E_OneWayList(),
                            new E_OneWayList(),
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.list3.E_OneWayList down$
                        = (org.jmlspecs.samples.list.list3.E_OneWayList) o$;
                    return down$.clone();
                }
            };
}
