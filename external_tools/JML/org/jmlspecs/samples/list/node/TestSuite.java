...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public static junit.framework.Test suite() {
        ...
        suite.addTest( org.jmlspecs.samples.list.node.OneWayNode_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.node.TwoWayNode_JML_Test.suite() );
        return suite;
    }

    public static final String TEST_DESC = 
        "Test suite for org.jmlspecs.samples.list.node";
}
