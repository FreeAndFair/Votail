// @(#)$Id: OneWayNode_JML_TestData.java,v 1.3 2004/01/22 20:00:57 leavens Exp $
 ...
 *
 */
public abstract class OneWayNode_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public OneWayNode_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for OneWayNode");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_node_OneWayNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_list_node_OneWayNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.list.node.OneWayNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_node_OneWayNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    OneWayNode node0 = new OneWayNode();
                    OneWayNode node1 = new OneWayNode("it");
                    OneWayNode node2 = new OneWayNode("first");
                    node2.insertAfter("fourth");
                    node2.insertAfter("third");
                    node2.insertAfter("second");
                    OneWayNode node3 = new OneWayNode("first");
                    node3.insertAfter("second");
                    OneWayNode node4 = new OneWayNode("fifth");
                    node4.insertAfter("sixth");
                    OneWayNode node5 = new OneWayNode("seventh");
                    node5.insertAfter("eighth");
                    OneWayNode node6 = new OneWayNode("ninth");
                    node6.insertAfter("tenth");
                    OneWayNode node7 = new OneWayNode("8");
                    node7.insertAfter("9");
                    node7 = node7.getNextNode();

                    return new org.jmlspecs.samples.list.node.OneWayNode[] {
                        null,
                        node0,
                        node1,
                        node2,
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.node.OneWayNode down$
                        = (org.jmlspecs.samples.list.node.OneWayNode) o$;
                    return down$.clone();
                }
            };
