// @(#)$Id: TwoWayNode_JML_TestData.java,v 1.5 2004/07/15 02:21:07 cruby Exp $
    ...
    extends junit.framework.TestCase
{
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    TwoWayNode node0 = new TwoWayNode();
                    ...
                    TwoWayNode node5 = new TwoWayNode("eighth4");
                    ...
                    return new org.jmlspecs.samples.list.node.TwoWayNode[] {
                        null,
                        node0,
                        node1,
                        node2,
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.node.TwoWayNode down$
                        = (org.jmlspecs.samples.list.node.TwoWayNode) o$;
                    return down$.clone();
                }
            };
    ...
    org.jmlspecs.samples.list.node.TwoWayNode nullNode = null;

    public void testNode04() {
	org.jmlspecs.samples.list.node.TwoWayNode var10 
	    = new org.jmlspecs.samples.list.node.TwoWayNode("t04-a", 
							    nullNode,
							    nullNode);
	var10.insertAfter("t04-b");
	var10.insertBefore("t04-c");
	org.jmlspecs.samples.list.node.TwoWayNode var143 
	    = var10.getPrevNode();
	...
	org.jmlspecs.samples.list.node.TwoWayNode var10 
	    = new org.jmlspecs.samples.list.node.TwoWayNode((Object)null,
							    nullNode,
							    nullNode);
	org.jmlspecs.samples.list.node.TwoWayNode var38 
	    = new org.jmlspecs.samples.list.node.TwoWayNode((Object)null, 
							    nullNode,
							    var10);
