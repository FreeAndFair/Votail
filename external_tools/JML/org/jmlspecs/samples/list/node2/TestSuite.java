...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public static junit.framework.Test suite() {
        ...
        suite.addTest( org.jmlspecs.samples.list.node2.OneWayNode_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.node2.TwoWayNode_JML_Test.suite() );
        return suite;
    }

    public static final String TEST_DESC = 
        "Test suite for org.jmlspecs.samples.list.node2";
}
