// @(#)$Id: OneWayNode_JML_TestData.java,v 1.3 2004/01/22 20:01:05 leavens Exp $
    ...
    extends junit.framework.TestCase
{
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_node2_OneWayNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_list_node2_OneWayNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.list.node2.OneWayNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_node2_OneWayNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    // !FIXME! disentangle the following...
                    OneWayNode node0 = new OneWayNode(null);
                    OneWayNode node1 = new OneWayNode("it");
                    OneWayNode node2 = new OneWayNode("first", node0);
                    OneWayNode node3 = new OneWayNode("second", null);
                    OneWayNode node4 = new OneWayNode("third", node2);
                    OneWayNode node5 = new OneWayNode("fourth", node3);
                    OneWayNode node6 = new OneWayNode(null, node5);
                    OneWayNode node7 = new OneWayNode(null, node0);
                    OneWayNode node8 = new OneWayNode("8");
                    node8.insertAfter(node5);
