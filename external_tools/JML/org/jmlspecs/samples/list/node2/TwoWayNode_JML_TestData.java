// @(#)$Id: TwoWayNode_JML_TestData.java,v 1.5 2004/09/30 04:46:17 cruby Exp $
 ...
 *
 */
public abstract class TwoWayNode_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public TwoWayNode_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for TwoWayNode");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_node2_TwoWayNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_list_node2_TwoWayNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.list.node2.TwoWayNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_node2_TwoWayNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    TwoWayNode node1 = new TwoWayNode("it");
                    TwoWayNode node2 = new TwoWayNode("first2");
                    node2.insertAfter("fourth2");
                    node2.insertAfter("third2");
                    node2.insertAfter("second2");
                    TwoWayNode node3 = new TwoWayNode("second3");
                    node3.insertBefore("first3");
                    TwoWayNode node4 = new TwoWayNode("fifth4");
                    node4.insertBefore("sixth4");
                    TwoWayNode node5 = new TwoWayNode("eighth5");
                    node5.insertBefore("seventh5");
                    TwoWayNode node6 = new TwoWayNode("tenth6");
                    node6.insertBefore("ninth6");
                    TwoWayNode node7 = new TwoWayNode("8-7");
                    node7.insertAfter("9-7");
                    node7 = (TwoWayNode) node7.getNextNode();
                    // !FIXME! can we disentangle the code above?
    ...
    static private org.jmlspecs.samples.list.node2.TwoWayNode nullNode = null;

    public void testNode04() {
	org.jmlspecs.samples.list.node2.TwoWayNode var10 
	    = new org.jmlspecs.samples.list.node2.TwoWayNode("t04-a", 
							      nullNode,
							      nullNode);
	var10.insertAfter("t04-b");
	var10.insertBefore("t04-c");
	org.jmlspecs.samples.list.node2.TwoWayNode var143 
	    = var10.getPrevNode();
	...
	org.jmlspecs.samples.list.node2.TwoWayNode var10 
	    = new org.jmlspecs.samples.list.node2.TwoWayNode((Object)null,
							      nullNode,
							      nullNode);
	org.jmlspecs.samples.list.node2.TwoWayNode var38 
	    = new org.jmlspecs.samples.list.node2.TwoWayNode((Object)null, 
							      nullNode,
							      var10);
