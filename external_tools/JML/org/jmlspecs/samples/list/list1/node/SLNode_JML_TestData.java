// @(#)$Id: SLNode_JML_TestData.java,v 1.3 2004/01/22 20:00:52 leavens Exp $
 ...
 *
 */
public abstract class SLNode_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public SLNode_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for SLNode");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_list_list1_node_SLNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_list_list1_node_SLNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.list.list1.node.SLNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_list_list1_node_SLNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    SLNode node0 = new SLNode(null);
                    SLNode node1 = new SLNode("it");
                    SLNode node2 = new SLNode("first", node0);
                    SLNode node3 = new SLNode("second", null);
                    SLNode node4 = new SLNode("third", node2);
                    SLNode node5 = new SLNode("fourth", node3);
                    SLNode node6 = new SLNode(null, node5);
                    SLNode node7 = new SLNode(null, node0);
                    SLNode node8 = new SLNode("8");
                    node8.insertAfter(node7);

                    return new org.jmlspecs.samples.list.list1.node.SLNode[] {
                        node0,
                        node1,
                        node2,
                        node3,
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.list1.node.SLNode down$
                        = (org.jmlspecs.samples.list.list1.node.SLNode) o$;
                    return down$.clone();
                }
            };
