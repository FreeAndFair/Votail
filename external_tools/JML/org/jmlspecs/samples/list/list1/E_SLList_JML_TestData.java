// @(#)$Id: E_SLList_JML_TestData.java,v 1.3 2004/01/22 20:00:50 leavens Exp $
 ...
 *
 */
public abstract class E_SLList_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public E_SLList_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for E_SLList");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    org.jmlspecs.samples.list.list1.E_SLList[] receivers
                        = new E_SLList[] { 
                            new E_SLList(),
                            new E_SLList(),
                            new E_SLList(),
                    ...
                    receivers[7] = new E_SLList(receivers[7]);
                    return receivers;
                }
