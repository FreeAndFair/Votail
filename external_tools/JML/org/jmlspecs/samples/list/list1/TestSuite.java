...
public class TestSuite extends junit.framework.TestSuite {
    ...
    public static junit.framework.Test suite() {
        ...
        suite.addTest( org.jmlspecs.samples.list.list1.ListIterator_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list1.SLList_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list1.E_SLList_JML_Test.suite() );
        suite.addTest( org.jmlspecs.samples.list.list1.DLList_JML_Test.suite() );
        return suite;
    }

    public static final String TEST_DESC = 
        "Test suite for org.jmlspecs.samples.list.list1";
}
