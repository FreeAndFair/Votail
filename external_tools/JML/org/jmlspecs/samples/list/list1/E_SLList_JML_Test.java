// This file was generated by jmlunit on Tue May 20 17:42:43 EDT 2008.
 ...
 * testing of E_SLList. The superclass of this class should be edited
 * to supply test data. However it's best not to edit this class
 * directly; instead use the command
 * <pre>
 *  jmlunit E_SLList.java
 * </pre>
 * to regenerate this class whenever E_SLList.java changes.
 */
public class E_SLList_JML_Test
     extends E_SLList_JML_TestData
{
    /** Initialize this class. */
    public E_SLList_JML_Test(java.lang.String name) {
        super(name);
    }
    ...
    /** Test to see if the code for class E_SLList
     * has been compiled with runtime assertion checking (i.e., by jmlc).
     * Code that is not compiled with jmlc would not make an effective test,
     * since no assertion checking would be done. */
    public void test$IsRACCompiled() {
        junit.framework.Assert.assertTrue("code for class E_SLList"
                + " was not compiled with jmlc"
                + " so no assertions will be checked!",
            org.jmlspecs.jmlrac.runtime.JMLChecker.isRACCompiled(E_SLList.class)
            );
    }
    ...
    */
    ...
    public static junit.framework.Test suite() {
        E_SLList_JML_Test testobj
            = new E_SLList_JML_Test("E_SLList_JML_Test");
        junit.framework.TestSuite testsuite = testobj.overallTestSuite();
        // Add instances of Test found by the reflection mechanism.
        testsuite.addTestSuite(E_SLList_JML_Test.class);
     ...
     * enclosing class.
     */
    protected static abstract class OneTest extends E_SLList_JML_Test {
     ...
     * E_SLList.  The framework will then run them.
    ...
    {
        try {
            this.addTestSuiteFor$TestE_SLList(overallTestSuite$);
    ...
    /** Add tests for the E_SLList contructor
     * to the overall test suite. */
    private void addTestSuiteFor$TestE_SLList
        (junit.framework.TestSuite overallTestSuite$)
    {
        junit.framework.TestSuite methodTests$
            = this.emptyTestSuiteFor("E_SLList");
        try {
            methodTests$.addTest
                (new TestE_SLList());
    ...
    /** Test for the E_SLList contructor. */
    protected static class TestE_SLList extends OneTest {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                ...
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("length", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"length\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestLength extends OneTest {
        /** The receiver */
        private org.jmlspecs.samples.list.list1.E_SLList receiver$;

        /** Initialize this instance. */
        public TestLength(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("length");
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("isEmpty", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"isEmpty\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestIsEmpty extends OneTest {
        ...
        /** Initialize this instance. */
        public TestIsEmpty(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("isEmpty");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("createIterator", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"createIterator\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestCreateIterator extends OneTest {
        ...
        /** Initialize this instance. */
        public TestCreateIterator(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("removeEntry", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"removeEntry\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestRemoveEntry extends OneTest {
        ...
        /** Initialize this instance. */
        public TestRemoveEntry(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("removeEntry");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("insertAfterCursor", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"insertAfterCursor\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IndefiniteIterator
    ...
    protected static class TestInsertAfterCursor extends OneTest {
        ...
        /** Initialize this instance. */
        public TestInsertAfterCursor(org.jmlspecs.samples.list.list1.E_SLList receiver$, java.lang.Object newEntry) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("insertBeforeCursor", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"insertBeforeCursor\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                    vjava_lang_Object$1$iter
    ...
    protected static class TestInsertBeforeCursor extends OneTest {
        ...
        /** Initialize this instance. */
        public TestInsertBeforeCursor(org.jmlspecs.samples.list.list1.E_SLList receiver$, java.lang.Object newEntry) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("replaceEntry", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"replaceEntry\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                    vjava_lang_Object$1$iter
    ...
    protected static class TestReplaceEntry extends OneTest {
        ...
        /** Initialize this instance. */
        public TestReplaceEntry(org.jmlspecs.samples.list.list1.E_SLList receiver$, java.lang.Object newEntry) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("append", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"append\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                    vjava_lang_Object$1$iter
    ...
    protected static class TestAppend extends OneTest {
        ...
        /** Initialize this instance. */
        public TestAppend(org.jmlspecs.samples.list.list1.E_SLList receiver$, java.lang.Object newEntry) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("removeAllEntries", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"removeAllEntries\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestRemoveAllEntries extends OneTest {
        ...
        /** Initialize this instance. */
        public TestRemoveAllEntries(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("clone", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"clone\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestClone extends OneTest {
        ...
        /** Initialize this instance. */
        public TestClone(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("clone");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("firstEntry", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"firstEntry\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestFirstEntry extends OneTest {
        ...
        /** Initialize this instance. */
        public TestFirstEntry(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("firstEntry");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("incrementCursor", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"incrementCursor\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestIncrementCursor extends OneTest {
        ...
        /** Initialize this instance. */
        public TestIncrementCursor(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("isOffFront", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"isOffFront\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestIsOffFront extends OneTest {
        ...
        /** Initialize this instance. */
        public TestIsOffFront(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("isOffFront");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("isOffEnd", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"isOffEnd\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestIsOffEnd extends OneTest {
        ...
        /** Initialize this instance. */
        public TestIsOffEnd(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("isOffEnd");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("getEntry", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"getEntry\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestGetEntry extends OneTest {
        ...
        /** Initialize this instance. */
        public TestGetEntry(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("getEntry");
            this.receiver$ = receiver$;
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vorg_jmlspecs_samples_list_list1_E_SLListIter("toString", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vorg_jmlspecs_samples_list_list1_E_SLListIter(\"toString\", 0))");
            while (!receivers$iter.atEnd()) {
                final org.jmlspecs.samples.list.list1.E_SLList receiver$
                    = (org.jmlspecs.samples.list.list1.E_SLList) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestToString extends OneTest {
        ...
        /** Initialize this instance. */
        public TestToString(org.jmlspecs.samples.list.list1.E_SLList receiver$) {
            super("toString");
            this.receiver$ = receiver$;
        }
