// @(#)$Id: DLList_JML_TestData.java,v 1.3 2004/01/22 20:00:50 leavens Exp $
 ...
 *
 */
public abstract class DLList_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public DLList_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for DLList");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    ...
                    receivers[7].insertBeforeCursor("8th");
                    receivers[7].insertBeforeCursor("7th");
                    receivers[7].insertBeforeCursor("6th");
                    receivers[7].insertBeforeCursor("5th");
                    receivers[8] = new DLList(receivers[7]);
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.list1.DLList down$
                        = (org.jmlspecs.samples.list.list1.DLList) o$;
                    return down$.clone();
                }
            };
