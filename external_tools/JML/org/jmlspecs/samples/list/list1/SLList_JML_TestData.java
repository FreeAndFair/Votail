// @(#)$Id: SLList_JML_TestData.java,v 1.3 2004/01/22 20:00:50 leavens Exp $
 ...
 *
 */
public abstract class SLList_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public SLList_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for SLList");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    ...
                    receivers[1].decreaseCursor();
                    receivers[1].insertAfterCursor("it");
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.list.list1.SLList down$
                        = (org.jmlspecs.samples.list.list1.SLList) o$;
                    return down$.clone();
                }
            };
