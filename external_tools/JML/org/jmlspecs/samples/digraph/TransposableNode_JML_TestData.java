// @(#)$Id: TransposableNode_JML_TestData.java,v 1.3 2004/01/22 20:00:24 leavens Exp $
 ...
 *
 */
public abstract class TransposableNode_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public TransposableNode_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for TransposableNode");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_digraph_TransposableNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_digraph_TransposableNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.digraph.TransposableNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_digraph_TransposableNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.samples.digraph.TransposableNode[] {
                     new TransposableNode(new Integer(0)),
                     new TransposableNode(null),
                     new TransposableNode(new Integer(2)),
                     new TransposableNode(new Integer(-2)),
                     null,
                    };
                }
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.digraph.TransposableNode down$
                        = (org.jmlspecs.samples.digraph.TransposableNode) o$;
                    return down$.clone();
                }
            };
