// @(#)$Id: SearchableNode_JML_TestData.java,v 1.3 2004/01/22 20:00:24 leavens Exp $
 ...
 *
 */
public abstract class SearchableNode_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public SearchableNode_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for SearchableNode");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    ...
                    new SearchableNode(new Integer(0), 0, 0,
                                       new SearchableNode(new Integer(3)),
                                       Color.WHITE),  
                    new SearchableNode(new Integer(-2), 2, 4, null,
                                       Color.WHITE),  
                    new SearchableNode(new Integer(29), -2, 5, null,
                                       Color.WHITE),
                    new SearchableNode(new Integer(29), 6, 0, null,
                                       Color.WHITE), 
                    null,
                    };
                }
