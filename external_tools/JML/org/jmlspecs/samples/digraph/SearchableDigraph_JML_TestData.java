// @(#)$Id: SearchableDigraph_JML_TestData.java,v 1.3 2004/01/22 20:00:24 leavens Exp $
 ...
 *
 */
public abstract class SearchableDigraph_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public SearchableDigraph_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for SearchableDigraph");
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_digraph_SearchableDigraphIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_digraph_SearchableDigraphStrategy.iterator();
    }

    private SearchableNode startNode;

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.digraph.SearchableDigraph. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_digraph_SearchableDigraphStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int i) {
                    SearchableDigraph receiver = new SearchableDigraph();
                    switch (i) {
                    case 0:
                        return receiver;
                    case 1:
                        startNode = new SearchableNode(new Object());
                        receiver.addNode(startNode);
                        return receiver;
                    case 2:
                        final int size2 = 5;
                        SearchableNode[] tn2 = new SearchableNode[size2];
                        for (int j = 0; j < size2; j += 1) {
                            tn2[j] = new SearchableNode(new Integer(j));
                    ...
                    case 3:
                        final int size3 = 5;
                        SearchableNode[] tn3 = new SearchableNode[size3];
                        for (int j = 0; j < size3; j += 1) {
                            tn3[j] = new SearchableNode(new Integer(j));
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_digraph_SearchableNodeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_digraph_SearchableNodeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.digraph.SearchableNode. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_digraph_SearchableNodeStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.samples.digraph.SearchableNode[] {
                        null,
                        new SearchableNode(new Integer(4)),
                        new SearchableNode(new Object()),
                    };
                }
                ...
                //@ requires o$ != null;
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.digraph.SearchableNode down$
                        = (org.jmlspecs.samples.digraph.SearchableNode) o$;
                    return down$.clone();
                }
            };
}
