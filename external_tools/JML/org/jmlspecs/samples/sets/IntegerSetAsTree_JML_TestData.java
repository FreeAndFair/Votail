// @(#)$Id: IntegerSetAsTree_JML_TestData.java,v 1.3 2004/01/22 20:01:52 leavens Exp $
 ...
 *
 */
public abstract class IntegerSetAsTree_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public IntegerSetAsTree_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for IntegerSetAsTree");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_sets_IntegerSetAsTreeIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_sets_IntegerSetAsTreeStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.sets.IntegerSetAsTree. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_sets_IntegerSetAsTreeStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    IntegerSetAsTree receiver;
                    switch (n) {
                    case 0:
                        return new IntegerSetAsTree();
                    case 1:
                        receiver = new IntegerSetAsTree();
                        receiver.insert(3);
                        return receiver;
                    case 2:
                        receiver = new IntegerSetAsTree();
