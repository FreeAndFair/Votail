// @(#)$Id: IntegerSetAsHashSet_JML_TestData.java,v 1.3 2004/01/22 20:01:51 leavens Exp $
 ...
 *
 */
public abstract class IntegerSetAsHashSet_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public IntegerSetAsHashSet_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for IntegerSetAsHashSet");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_sets_IntegerSetAsHashSetIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_sets_IntegerSetAsHashSetStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.sets.IntegerSetAsHashSet. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_sets_IntegerSetAsHashSetStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int i) {
                    IntegerSetAsHashSet receiver;
                    switch (i) {
                    case 0:
                        receiver = new IntegerSetAsHashSet();
                        return receiver;
                    case 1:
                        receiver = new IntegerSetAsHashSet();
                        receiver.insert(3);
