// @(#)$Id: BlankReader_JML_TestData.java,v 1.3 2004/01/22 20:01:45 leavens Exp $
 ...
 *
 */
public abstract class BlankReader_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public BlankReader_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for BlankReader");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_reader_BlankReaderIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_reader_BlankReaderStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.reader.BlankReader. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_reader_BlankReaderStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                        return new BlankReader(0);
                    case 1:
                        return new BlankReader(50);
                    case 2:
                        return new BlankReader(8191);
                    case 3:
                        return new BlankReader(8192);
                    case 4:
                        return new BlankReader(8193);
                    case 5:
                        return new BlankReader(15123);
                    case 6:
                        return null;
                    default:
                        break;
