// @(#)$Id: PlusAccount_JML_TestData.java,v 1.3 2004/01/22 20:01:40 leavens Exp $
 ...
 *
 */
public abstract class PlusAccount_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public PlusAccount_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for PlusAccount");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_PlusAccountIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_PlusAccountStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.PlusAccount. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_PlusAccountStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 0:
                        return null;
                    case 1:
                        return new PlusAccount(new USMoney(10.52),
                                               new USMoney(17.43), 
                                               "Janet Leavens");
                    case 2:
                        return new PlusAccount(new USMoney(1000.52),
                                               new USMoney(0.02),
                                               "Baby");
                    default:
                        break;
