// @(#)$Id: Account_JML_TestData.java,v 1.3 2004/01/22 20:01:40 leavens Exp $
 ...
 *
 */
public abstract class Account_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Account_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Account");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_MoneyOpsIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_MoneyOpsStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.MoneyOps. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_MoneyOpsStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    ...
                    case 0:
                        return null;
                    case 1:
                        return new USMoney(0L);
                    case 2:
                        return new USMoney(10L);
                    case 3:
                        return new USMoney(-10.11);
                    case 4:
                        return new USMoney(32.50);
                    default:
                        break;
                    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_AccountIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_AccountStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.Account. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_AccountStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                        return null;
                    case 1:
                        return new Account(new USMoney(1L), "Yoonsik");
                    case 2:
                        return new Account(new USMoney(32.50), "Curt");
                    case 3:
                        return new Account(new USMoney(11.25), "Clyde");
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
