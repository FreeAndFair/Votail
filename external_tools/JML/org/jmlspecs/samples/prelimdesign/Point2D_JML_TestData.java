// @(#)$Id: Point2D_JML_TestData.java,v 1.3 2004/01/22 20:01:41 leavens Exp $
 ...
 *
 */
public abstract class Point2D_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Point2D_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Point2D");
    }
     ...
     * org.jmlspecs.samples.prelimdesign.Point2D
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_Point2DIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_Point2DStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.Point2D. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_Point2DStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                        return new org.jmlspecs.samples.prelimdesign.Point2D();
                    case 1:
                        return new org.jmlspecs.samples.prelimdesign.Point2D(-5.0, 3.14);
                    case 2:
                        return new org.jmlspecs.samples.prelimdesign.Point2D(72.5, 0.3e-4);
                    case 3:
                        return null;
                    default:
                        break;
        ...
        = new org.jmlspecs.jmlunit.strategies.DoubleBigStrategy()
            {
                protected double[] addData() {
                    return new double[] {
                        72.5, 7.21, -8.0, -1.34e-27, 3.2e-35,
                    };
                }
            };
}
