// @(#)$Id: USMoney_JML_TestData.java,v 1.3 2004/01/22 20:01:41 leavens Exp $
 ...
 *
 */
public abstract class USMoney_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public USMoney_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for USMoney");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_USMoneyIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_USMoneyStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.USMoney. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_USMoneyStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.samples.prelimdesign.USMoney[] {
                        null,
                        new USMoney(0L),
                        new USMoney(32.50),
                        new USMoney(-121.11),
                ...
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.prelimdesign.USMoney down$
                        = (org.jmlspecs.samples.prelimdesign.USMoney) o$;
                    return down$.clone();
                }
            };
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_prelimdesign_MoneyIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_prelimdesign_MoneyStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.prelimdesign.Money. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_prelimdesign_MoneyStrategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new org.jmlspecs.samples.prelimdesign.Money[] {
                        null,
                        new USMoney(0L),
                        new USMoney(99954L),
                        new USMoney(-121.11),
                ...
                //@ requires o$ != null;
                protected Object cloneElement(java.lang.Object o$) {
                    org.jmlspecs.samples.prelimdesign.Money down$
                        = (org.jmlspecs.samples.prelimdesign.Money) o$;
                    return down$.clone();
                }
            };
    ...
    private org.jmlspecs.jmlunit.strategies.LongStrategyType
        vlongStrategy
        = new org.jmlspecs.jmlunit.strategies.LongBigStrategy()
            {
                protected long[] addData() {
                    return new long[] {
                        7, Long.MAX_VALUE-1, Long.MIN_VALUE+1,
                    };
                }
            };
}
