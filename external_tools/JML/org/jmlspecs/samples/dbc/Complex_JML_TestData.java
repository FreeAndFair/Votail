// @(#)$Id: Complex_JML_TestData.java,v 1.3 2004/01/22 20:00:20 leavens Exp $
 ...
 *
 */
public abstract class Complex_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Complex_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Complex");
    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vorg_jmlspecs_samples_dbc_ComplexIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vorg_jmlspecs_samples_dbc_ComplexStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * org.jmlspecs.samples.dbc.Complex. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vorg_jmlspecs_samples_dbc_ComplexStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    ...
                    case 2:
                        return new Rectangular(2.0, 0.0);
                    case 3:
                        return new Rectangular(2.1, 3.4);
                    case 4:
                        return new Rectangular(-10.0, 75.2);
                    case 5:
                        return new Rectangular(-57.34, -0.1e-10);
                    case 6:
                        return new Polar(0.0, 0.0);
                    case 7:
                        return new Polar(2.1, StrictMath.PI / 3);
                    case 8:
                        return new Polar(7.5, StrictMath.PI - 0.02);
                    case 9:
                        return new Polar(-10.6, 3 * StrictMath.PI / 2);
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
