// @(#)$Id: Purse2_JML_TestData.java,v 1.3 2004/07/20 22:42:32 leavens Exp $
 ...
 */
public abstract class Purse2_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public Purse2_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for Purse2");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        ...
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vPurse2Strategy.iterator();
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                        return new Purse2(1,0,p);
                    case 1:
                        return new Purse2(1,1,p);
                    case 2:
                        return new Purse2(100,53,p);
                    default:
                        break;
                    }
