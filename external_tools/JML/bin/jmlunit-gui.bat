@ECHO OFF
rem @(#)$Date: 2004/01/27 20:15:27 $
rem
rem jmlunit -- script for running the JML/JUnit test oracle generator
rem
rem SYNOPSIS: set CLASSPATH and run JML/JUnit test oracle generator
...
java -mx128m org.jmlspecs.jmlunit.JntGUI %CMDLINE_ARGS%
