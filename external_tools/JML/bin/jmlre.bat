...
rem
rem jmlre --  script for running java programs compiled with
rem            the JML executable specification compiler
rem
...
set CLASSPATH=%CLASSPATH%;%JMLDIR%\bin\jml-release.jar
