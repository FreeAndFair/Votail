@ECHO OFF
rem  @(#)$Date: 2004/01/27 03:20:12 $
rem
rem jmldoc -- script for running the JML documentation generator, jmldoc
rem
rem SYNOPSIS: set CLASSPATH and run jmldoc

call jmlenv.bat

rem save the old CLASSPATH
set OLDCLASSPATH=%CLASSPATH%
set CLASSPATH=.;%JMLDIR%\bin\jml-release.jar;%JMLDIR%\specs;%JDKTOOLS%;%CLASSPATH%
...
java -mx128m org.jmlspecs.jmldoc.Main %CMDLINE_ARGS%
