...
rem
rem jmle -- script for running the JML executable specification compiler
rem
rem SYNOPSIS: set CLASSPATH and run the JML executable specification compiler
...
java -mx128m org.jmlspecs.jmlexec.Main %CMDLINE_ARGS%
