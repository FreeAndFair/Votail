@ECHO OFF
rem @(#)$Date: 2004/01/27 15:15:27 $
rem
rem jmlspec -- script for invoking the JML skeleton specification generator
rem
rem SYNOPSIS: set CLASSPATH and run jmlspec.
...
java -mx128m org.jmlspecs.jmlspec.JspGUI %CMDLINE_ARGS%
